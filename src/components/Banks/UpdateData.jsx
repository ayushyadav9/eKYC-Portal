            ...
            <Flex mx={-3} flexWrap={"wrap"}>
              ...
              <Box width={1} px={3}>
                <Field label="Phone No." width={1}>
                  <Form.Input type="text" name="phone" value={formData.phone} onChange={(e)=>setformData({...formData,'phone':e.target.value})} required width={1} />
                </Field>
              </Box>
              <Flex px={1} mx={'100px'}>
                <Box width={1} px={3}>
                ...
                <Box width={1} px={3}>
                  <Field label="Gender" width={1}>
                    <Form.Input type="text" name="gender" value={formData.gender} onChange={(e)=>setformData({...formData,'gender':e.target.value})} required width={1} />
                  </Field>
                </Box>
              </Flex>
              <Box width={1} px={3}>
                <Field label="PAN Number" width={1}>
                  <Form.Input type="text" name="PANno" value={formData.PANno} onChange={(e)=>setformData({...formData,'PANno':e.target.value})} required width={1} />
                </Field>
              </Box>
              <Flex px={1} mx={'100px'}>
                <Box width={1} px={3}>
